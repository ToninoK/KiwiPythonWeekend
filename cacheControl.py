...
class CacheController:
    ...
    def cacheJourneys(self, journeys, search_data):
        ...
        self.red.setex(journeys_name, json.dumps({'journeys':[journey.toDict() for journey in journeys]}), 60*60)
        return journeys
    ...
    def createName(self, search_data):
        return slugify(f"journey:{search_data[0]}_{search_data[1]}_{search_data[2]}:tonino")